...
]).push([[2],
{
    ...
    !function (e) {
      ...
      let s = (() =>{
        class t{
          ...
          staticget currentTask() {
            return O
          }
          static__load_patch(s, i) {
          ...
          runTask(e, t, n) {
            ...
            try {
              ...
              e.state !== k && e.state !== w && (e.type == S || e.data && e.data.isPeriodic ? o && e._transitionTo(b, v)  : (e.runCount = 0, this._updateTaskCount(e, - 1), o && e._transitionTo(k, v, k))),
              P = P.parent,
              O = r
            }
          }
          scheduleTask(e) {
            if (e.zone && e.zone !== this) {
              let t = this;
              for (; t; ) {
                if (t === e.zone) throw Error(`can not reschedule task to ${this.name
              }
  ...
  class c{
    ...
    _transitionTo(e, t, n) {
      if (this._state !== t && this._state !== n) throw new Error(`${this.type
    }
     '${this.source
  }
  ': can not transition to '${e
}
', expecting state '${t
}
'${n ? ' or \'' + n + '\'' : ''
...
if (!1 !== o && s instanceof Z && s.hasOwnProperty(d) && s.hasOwnProperty(g) && null !== s[d]) w(s),
v(e, s[d], s[g]);
...
r = n && _ === n[_];
r && (n[m] = o, n[k] = s);
const a = t.run(i, void 0, r && i !== f && i !== p ? [
] : [
o
]);
v(n, !0, a)
...
for (let iofe) h(i) || (i = this.resolve(i)),
i.then(r, s);
return o
}
staticall(e) {
...
y = !('nw' in d) && void 0 !== d.process && '[object process]' === {
}.toString.call(d.process),
b = !y && !k && !(!p || !f.HTMLElement),
v = void 0 !== d.process && '[object process]' === {
}.toString.call(d.process) && !k && !(!p || !f.HTMLElement),
T = {
},
w = function (e) {
...
} else r = o && o.apply(this, arguments),
...
let n = this;
n || e !== d || (n = d),
n && (n[u] && n.removeEventListener(l, w), c && c.apply(n, g), 'function' == typeof t ? (n[u] = t, n.addEventListener(l, w, !1))  : n[u] = null)
},
s.get = function () {
let n = this;
...
::` + t, s = a.prototype; if (s.hasOwnProperty(t)) {
...
console.log(`Attempting to configure '${t
}
' with descriptor '${o
}
' on object '${e
...
'undefined' != typeof IDBIndex && (ue(IDBIndex.prototype, se, o), ue(IDBRequest.prototype, se, o), ue(IDBOpenDBRequest.prototype, se, o), ue(IDBDatabase.prototype, se, o), ue(IDBTransaction.prototype, se, o), ue(IDBCursor.prototype, se, o)),
...
s && 'string' == typeof s.type ? 'notScheduled' !== s.state && (s.cancelFn && s.data.isPeriodic || 0 === s.runCount) && ('number' == typeof r ? delete i[r] : r && (r[pe] = null), s.zone.cancelTask(s))  : t.apply(e, o)
})
}
function de(e, t) {
...
return a && a.prototype ? (t.patchEventTarget(e, [
a && a.prototype
]), !0)  : void 0
}
...
= t.getGlobalObjects();
(n || o) && e.customElements && 'customElements' in e && t.patchCallbacks(t, e.customElements, 'customElements', 'define', [
'connectedCallback',
